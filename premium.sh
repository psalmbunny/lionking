...
# get file
wget -O /etc/premium.zip "https://github.com/psalmbunny/lionking/blob/master/premium.zip"
cd /etc/
unzip premium.zip
cd
wget -O /var/var.zip "https://github.com/psalmbunny/lionking/blob/master/var.zip"
cd /var/
unzip var.zip
cd
...
#          Server System: Lion King VPN     #
#            Owner: TEAM Lion King VPN      #
#############################################';
